...
public:
    ...
    //void getSDFParameter(Scene &scene, sdf::ElementPtr sdf, const std::string &parameterName);private:
...
}; /* template <> bool GazeboSceneLoader::readValue<bool>(const nlohmann::json &j, bool &v); */
}
