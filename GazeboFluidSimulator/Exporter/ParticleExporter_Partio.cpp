...
ParticleExporter_Partio::ParticleExporter_Partio(GazeboSimulatorBase *base) :
	ExporterBase(base)
{
}
...
void ParticleExporter_Partio::writeParticlesPartio(const std::string& fileName, FluidModel* model)
{
	...
	StringTools::tokenize(m_base->getValue<std::string>(GazeboSimulatorBase::PARTICLE_EXPORT_ATTRIBUTES), attributes, ";");
