...
void FluidVisPlugin::RenderAsPointsUpdate()
{
	...
	if (this->newFluidMsgReceived)
	{
		...
		FluidVisPlugin::RenderParticlesAsEntities(this->fluidParticlePositions, "fluid1","Gazebo/Blue");
		FluidVisPlugin::RenderParticles(this->rigidsParticlePositions, "rigid1");

		FluidVisPlugin::RenderParticles(this->rigidsParticlePositions, "rigid1");
		FluidVisPlugin::RenderParticlesAsEntities(this->rigidsParticlePositions, "rigid1","Gazebo/Red");
		this->newFluidMsgReceived = false;
	}
}
/////////////////////////////////////////////////
